...
//给收货地址添加一个事件代理
var last_confirm = document.getElementById("last_confirm");
var oAddressUl = document.querySelector('.address-ul');
oAddressUl.onclick = function(event) {
  ...
  if (target.className === 'delete') {
    ...
    //先让所有li元素的样式清空
  	...
  	last_confirm.innerHTML = "<br/>" + target.children[0].innerHTML + "<br/><br/>" + target.children[3].innerHTML + "<br/><br/>" + target.children[5].innerHTML;
	}
}
...
//<!--提交订单功能-->
var oOrder = document.querySelector('#order_submit');
